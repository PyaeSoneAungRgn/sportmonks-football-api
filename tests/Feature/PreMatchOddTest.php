...
it('can get all odds', function () {
    expect(football()->preMatchOdd()->all())->toBeInstanceOf(\Illuminate\Http\Client\Response::class);
});
...
it('can get last updated odds', function () {
    expect(football()->preMatchOdd()->lastUpdated())->toBeInstanceOf(\Illuminate\Http\Client\Response::class);
});
