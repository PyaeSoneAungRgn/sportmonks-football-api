...
class StandingResource extends BaseResource
{
    ...
    public function byRoundId(int|string $id): array|Collection|Response|ResponseDto
    {
        return $this->get(
    ...
    public function standingCorrectionBySeasonId(int|string $id): array|Collection|Response|ResponseDto
    {
        return $this->get(
    ...
    public function liveStandingsByLeagueId(int|string $id): array|Collection|Response|ResponseDto
    {
        return $this->get(
